# Contact Database Sales Telegram Bot

Telegram-бот для продажи баз данных контактов компаний с автоматической оплатой через ЮMoney и доставкой файлов из Google Drive.
...
3. Введите имя бота (например: "База контактов")
4. Введите username бота (например: `mycontactsbot` - должен заканчиваться на `bot`)
