...
DEMO_TEXT = """📊 ДЕМО-ФАЙЛ БАЗЫ

🧩 В демо — только 5 компаний для примера в полном формате.
В полной базе таких записей сотни раз больше, так же возможно наличие данных которые здесь не указаны или отсутствуют."""
